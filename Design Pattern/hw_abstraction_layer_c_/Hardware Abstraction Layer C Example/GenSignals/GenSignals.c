...
typedef ViStatus (_VI_FUNC *GenerateSignalFuncPtr) (ViSession vi, ViReal64 frequency,
                                                      ViReal64 amplitude);



/****************************************************************************
 *  GenSignals Function Names, Tables, and Typedefs
 ****************************************************************************/
enum
    {
	kGenerateSignal = kNumInherentFunctions,
    kNumFunctions
    };
...
static IviStringValueTable funcTable =
    {
    INHERENT_FUNCTION_TABLE(GenSignals),
	{kGenerateSignal,		"GenSignals_GenerateSignal"},		
    {VI_NULL, VI_NULL}
    };
...
#define GENSIGNALS_SIMULATE_BEGIN(f)        IVI_SIMULATE_BEGIN(f, GenSignals, GENSIGNALS)
...
ViStatus _VI_FUNC GenSignals_init (ViRsrc logicalName,
                               ...
                               ViSession* newSession)
{
    printf("In HAL DSSP Interface function: GenSignals_InitWithOptions...\n");
    ViStatus  error = VI_SUCCESS;
    ...
    GENSIGNALS_SIMULATE_BEGIN(InitSimStatus)
    SIMULATE_END()
...
/****************************************************************************
 *  Function: GenSignals_InitWithOptions
 *  Purpose:  Open an instrument session, queries the instrument ID, and
 *            initializes the instrument to a known state.
 ****************************************************************************/
...
/****************************************************************************
 *  Function: GenSignals_GetAttributeViBoolean
 ...
 ****************************************************************************/
/****************************************************************************
 *  Function: GenSignals_GenerateSignal
 *  Purpose: Generate signal
 ****************************************************************************/
ViStatus _VI_FUNC GenSignals_GenerateSignal (ViSession vi, ViReal64 frequency, ViReal64 amplitude)
{
    printf("In HAL DSSP Interface function: GenSignals_GenerateSignal...\n");
	DECLARE(GenerateSignal)

	LOCK()

	SPECIFIC_CALL_BEGIN(GenerateSignal)
		SPECIFIC_CALL_ARG(frequency)
		SPECIFIC_CALL_ARG(amplitude)
	SPECIFIC_CALL_END()

	GENSIGNALS_SIMULATE_BEGIN(GenerateSignal)
		SIMULATE_ARG(frequency)
		SIMULATE_ARG(amplitude)
...
static ViStatus ClassUtil_DisposeSession (ViSession vi)
{
    ...
    /* Dispose of the DSSP Adapter session */
